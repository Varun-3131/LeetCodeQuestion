...
public class FindLongestSpecialSubStringThatOccursThrice_II {
    // Function to find the maximum length of a substring with at least three repeating characters
